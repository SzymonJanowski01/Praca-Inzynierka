...
def match_champions_with_ids(champions_list: list[str]) -> list[int]:
    matched_champions_ids: list[int] = [champions_ids[champions_names.index(champion)] for champion in champions_list]

    return matched_champions_ids


def match_champions_with_names(champions_ids_list: dict[str, list[int]]) -> dict[str, list[int]]:
    matched_champions_names: dict[str, list[int]] = {
        region: [champions_names[champions_ids.index(champion)] for champion in champions_list] for
        region, champions_list in champions_ids_list.items()}

    return matched_champions_names
